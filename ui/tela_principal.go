...
func criarTelaPrincipal(janela fyne.Window, cliente *zabbix.ClienteAPI, fnAbrirConfig func()) (fyne.CanvasObject, func()) {
	...
	tabelaHosts.SetColumnWidth(1, 200)
	...
	botaoExportar := widget.NewButtonWithIcon("Exportar Relatório", theme.DocumentSaveIcon(), func() {
		...
		dialogoSalvar.SetFileName("Relatorio_Zabbix.csv")
